...
flowchart LR
    subgraph L[" "]
        direction TB
        A["🧾 <b>Messy real-world</b><br/><b>statements</b><br/><br/>Inconsistent columns,<br/>merged fields, and<br/>OCR-prone PDF layouts"]
        B["🔁 <b>Recurring expense</b><br/><b>detection</b><br/><br/>Rent, SIP and subscriptions<br/>vs. coincidental<br/>similar amounts"]
        C["📉 <b>Forecast</b><br/><b>uncertainty</b><br/><br/>Short transaction history<br/>leads to noisy<br/>early forecasts"]
        D["🌐 <b>Multi-currency</b><br/><b>consistency</b><br/><br/>INR / USD / EUR across<br/>every KPI<br/>and chart"]
    end

    A -.-> A1["✅ <b>Robust parsing layer</b>"]
    B -.-> B1["✅ <b>Careful rule design</b>"]
    C -.-> C1["✅ <b>Wide, clear confidence<br/>intervals</b>"]
    D -.-> D1["✅ <b>Careful state<br/>management</b>"]
