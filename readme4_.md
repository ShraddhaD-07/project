...
7. [🛠️ Technology Stack](#7-️-technology-stack)
...
11. [💡 What We Learned](#11--what-we-learned)
...
**📂 Upload a Statement**
Drop in a bank statement and the system automatically classifies every transaction.

</td>
<td width="33%" valign="top">

**📊 90-Day Forecast**
Builds a forward-looking balance forecast so low points are visible days in advance.

</td>
<td width="33%" valign="top">

**💡 Plain-Language Insight**
Surfaces savings opportunities and explains forecasts in language anyone can understand.
...
> [!WARNING]
> **The result:** financial anxiety driven by uncertainty, not income.
...
```mermaid
flowchart LR
    A["📂 Upload<br/>CSV / Excel / PDF"] --> B["🏷️ Classification<br/>Agent"]
    B --> C["🔮 Forecasting Agent<br/>Prophet / ARIMA"]
    B --> D["💬 Insight Agent<br/>OpenAI explanations"]
    C --> E["🔗 API Layer<br/>Agent collaboration"]
    D --> E
    E --> F["📊 Dashboard<br/>User-facing"]

    classDef blue fill:#1E3A8A,stroke:#60A5FA,stroke-width:2px,color:#EFF6FF,rx:10,ry:10
    classDef green fill:#065F46,stroke:#34D399,stroke-width:2px,color:#ECFDF5,rx:10,ry:10
    classDef amber fill:#92400E,stroke:#FBBF24,stroke-width:2px,color:#FFFBEB,rx:10,ry:10
    classDef pink fill:#9D174D,stroke:#F472B6,stroke-width:2px,color:#FDF2F8,rx:10,ry:10
    class A,B blue
    class C green
    class D amber
    class E pink
